...
import { deleteAdmin, getAdmins, getElectionDates, login, sendAdmin, sendOtp, signup, updateNominations, updateVotings } from "../controllers/admin.js";
...
router.get("/",verifyUser,sendAdmin);
